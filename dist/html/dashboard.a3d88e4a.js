...
})({"gPBAR":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "5ed2d7a9a3d88e4a";
"use strict";
...
},{}],"ktkKI":[function(require,module,exports) {
var _fetchBookingsJs = require("./fetchBookings.js");
var _createBookingJs = require("./createBooking.js");
var _fetchMenuJs = require("./fetchMenu.js");
var _createMenuJs = require("./createMenu.js");
var _protectedJs = require("./protected.js");
var _utilsJs = require("./utils.js");
// Gör funktionerna tillgängliga globalt
window.myFunction = (0, _utilsJs.myFunction);
...
function createMenuItem() {
    ...
    const description = (0, _fetchMenuJs.sanitizeInput)(document.getElementById("description").value);
    const price = (0, _fetchMenuJs.sanitizeInput)(document.getElementById("price").value);
    const category = (0, _fetchMenuJs.sanitizeInput)(document.getElementById("category").value);
    fetch("https://backend-baserad-webbutveckling-moment-5.onrender.com/api/menu", {
        ...
        (0, _fetchMenuJs.fetchMenuItems)(); // Uppdatera menyalternativen
        (0, _fetchMenuJs.clearMenuForm)(); // Rensa formuläret
        (0, _utilsJs.showSnackbar)("Menyalternativ skapat!");
    }).catch((error)=>{
...
function fetchProtectedData() {
    ...
    fetch("https://backend-baserad-webbutveckling-moment-5.onrender.com/api/protected", {
        ...
        if (feedback) feedback.textContent = "Ett fel intr\xe4ffade vid h\xe4mtning av data. V\xe4nligen f\xf6rs\xf6k igen.";
    });
}
...
},{}]},["gPBAR","ktkKI"], "ktkKI", "parcelRequire0f18")

//# sourceMappingURL=dashboard.a3d88e4a.js.map
